  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: "800px",
        height: "800px",
        background: "radial-gradient(circle, rgba(108,99,255,0.12), rgba(168,85,247,0.08), transparent 65%)",
        pointerEvents: "none",
      }} />
      <div style={{
        position: "absolute",
      ...
      <div style={{
        ...
        right: 0,
        height: "1px",
        background: "linear-gradient(90deg, transparent, rgba(108,99,255,0.3), rgba(0,209,255,0.3), transparent)",
      }} />
      <div style={{
        position: "absolute",
        bottom: 0,
      ...
      <div className="container-custom" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          {["1,200+ Students Trained", "7 Days Program", "Govt. Certified Trainer", "Real Projects Only"].map((item, i) => (
            <div key={i} style={{
              display: "flex",
              alignItems: "center",
              gap: "8px",
