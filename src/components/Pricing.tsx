            ...
            >
              ...
              {plan.highlight && (
                <div style={{
                  ...
                  boxShadow: "inset 0 0 30px rgba(108,99,255,0.05), 0 0 30px rgba(108,99,255,0.2)",
                  pointerEvents: "none",
                }} />
              )}
                ...
                {plan.features.map((feat, j) => (
                  <li key={j} style={{ display: "flex", alignItems: "flex-start", gap: "10px" }}>
                    <div style={{
                      ...
                      height: "20px",
                      borderRadius: "50%",
                      background: plan.highlight ? "rgba(108,99,255,0.3)" : "rgba(255,255,255,0.08)",
                      display: "flex",
                      alignItems: "center",
                      ...
                      <span style={{ fontSize: "10px", color: plan.highlight ? "#00D1FF" : "#6C63FF" }}>✓</span>
                    </div>
                    <span style={{
                      fontFamily: "'Inter', sans-serif",
                      fontSize: "14px",
